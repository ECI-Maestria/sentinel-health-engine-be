// Package middleware provides Gin middleware for JWT authentication and role-based authorization.
package middleware
...
// Claims represents the JWT payload expected by all Sentinel Health Engine services.
type Claims struct {
...
// RequireAuth must precede this middleware in the chain.
